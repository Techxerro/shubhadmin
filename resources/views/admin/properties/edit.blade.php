            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="property_type"
                        ...
                        <option value="international"
                            {{ old('property_type', $property->property_type) == 'international' ? 'selected' : '' }}>
                            International
                        </option>
                        <option value="ready to move"
                            {{ old('property_type', $property->property_type) == 'ready to move' ? 'selected' : '' }}>
                            Ready to Move
                        </option>
                ...
                <div>
                    ...
                    <select name="is_featured"
                        ...
                        <option value="0"
                            {{ old('is_featured', $property->is_featured) == 0 ? 'selected' : '' }}>
                            No
                        </option>

                        <option value="1"
                            {{ old('is_featured', $property->is_featured) == 1 ? 'selected' : '' }}>
                            Yes (Featured)
                        </option>
